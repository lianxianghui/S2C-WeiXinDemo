...
@interface LXHFindView()
@end

@implementation LXHFindView
...
- (void)makeConstraints {
    [self.listView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(self.customNavigationBar.mas_bottom).offset(15);
    }];
...
- (UILabel *)title {
    if (!_title) {
        ...
        NSAttributedString *text = [[NSAttributedString alloc] initWithString:NSLocalizedString(@"发现", nil) attributes:textAttributes];
