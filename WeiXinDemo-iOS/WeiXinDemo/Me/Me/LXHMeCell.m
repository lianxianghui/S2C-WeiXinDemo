...
- (UIImageView *)leftImage {
    if (!_leftImage) {
        ...
        _leftImage.alpha = 1;
        _leftImage.image = [UIImage imageNamed:@"me_me_cell_left_image"];
    }
    return _leftImage;
}
...
- (UILabel *)name {
    if (!_name) {
        ...
        NSAttributedString *text = [[NSAttributedString alloc] initWithString:NSLocalizedString(@"收藏", nil) attributes:textAttributes];
...
- (UIImageView *)rightIcon {
    if (!_rightIcon) {
        ...
        _rightIcon.alpha = 1;
        _rightIcon.image = [UIImage imageNamed:@"me_me_cell_right_icon"];
    }
    return _rightIcon;
}
