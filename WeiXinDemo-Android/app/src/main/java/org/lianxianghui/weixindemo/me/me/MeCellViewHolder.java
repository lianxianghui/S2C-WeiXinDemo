...
public class MeCellViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    private MeCellData mMeCellData;
    ...
    public void bind(MeCellData meCell) {
        mMeCellData = meCell;
        mName.setText(mMeCellData.getName());
        String imageName = mMeCellData.getLeftImage();
        if (imageName != null) {
        ...
        imageName = mMeCellData.getRightIcon();
        if (imageName != null) {
        ...
        boolean clickable = mMeCellData.getClickable();
        if (clickable) {
