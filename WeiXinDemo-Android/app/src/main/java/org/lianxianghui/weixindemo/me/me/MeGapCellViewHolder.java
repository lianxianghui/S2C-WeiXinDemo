...
public class MeGapCellViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    private MeGapCellData mMeGapCellData;
    ...
    public void bind(MeGapCellData meGapCell) {
        mMeGapCellData = meGapCell;
        boolean clickable = mMeGapCellData.getClickable();
        if (clickable) {
